...
ipcMain.on('openMSALoginWindow', (ipcEvent, args) => {
    ...
    MSALoginWindow.loadURL('https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize?prompt=consent&client_id=3530b541-1564-4c3d-bb2f-407c1b0e0e5d&response_type=code&scope=XboxLive.signin%20offline_access&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient')
})